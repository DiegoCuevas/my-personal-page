...
> Una gema de Ruby para la API de Discord(https://www.rubydoc.info/gems/discordrb)
```sh
$ gem install discordrb o bundle add discordrb
``` 

> Necesitarás esto para que funcione la función de voz de discordrb
```sh
...
> Despues mandar la imagen, le hacemos un sleep a nuestra funcion por dos segundos (que hace que se detenga la funcion por el tiempo dicho) 
